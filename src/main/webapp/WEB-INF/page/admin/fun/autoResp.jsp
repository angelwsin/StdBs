    ...
    <div class="inner wrp">
        <h1 class="logo"><a href="https://mp.weixin.qq.com/" title="微信公众平台"></a></h1>
                        ...
                        <div class="account_meta account_info account_meta_primary">
                                ...
                                <a href="https://mp.weixin.qq.com/cgi-bin/settingpage?t=setting/index&action=index&token=1423695882&lang=zh_CN"><img src="./微信公众平台1_files/getheadimg" class="avatar"></a>
                            </div>
    ...
    <dt class="menu_title">
        ...
        https://res.wx.qq.com/mpres/htmledition/images/icon/menu/icon_menu_function.png
				...
				<dd class="menu_item "><a data-id="10005" href="${root }/adminWXFun/batchSend">群发功能        </a></dd>
					...
					<dd class="menu_item "><a data-id="10007" href="https://mp.weixin.qq.com/advanced/selfmenu?action=index&t=advanced/menu-setting&token=1423695882&lang=zh_CN">自定义菜单        </a></dd>
            ...
            <div class="section_tab">
                <ul class="tab_navs">
                    <li class="tab_nav  selected">
                        <a href="./微信公众平台1_files/微信公众平台1.html">被添加自动回复</a>
                    </li>
                    <li class="tab_nav  ">
...
<script type="text/javascript">
    ...
    window.wx ={
        ...
        data:{
            ...
            nick_name:"夕阳雨",
            time:"1443179321"||new Date().getTime()/1000
        },
        path:{
...
<div class="faqscene_inner">
...
</div><div class="dialog_wrp  ui-draggable" style="width: 726px; margin-left: -363px; margin-top: -200.5px; display: none;">
	<div class="dialog">
		<div class="dialog_hd">
			<h3>提示</h3>
			<!--#0001#-->
    ...
    <div class="page_msg simple default">
        <div class="inner">
            ...
            <div class="msg_content">
                ...
                <ul>
                    ...
                    <li>1. 阅读接入指南<a href="http://mp.weixin.qq.com/wiki" target="_blank">接口文档</a>，并在<a href="https://mp.weixin.qq.com/advanced/advanced?action=dev&t=advanced/dev&token=1423695882" target="_blank">开发者中心</a>设置回调URL和Token</li>
		...
		<div class="dialog_ft">
            ...
            <span class="btn btn_primary btn_input js_btn_p"><button type="button" class="js_btn" data-index="0">我知道了</button></span>
	        
		</div>
		
	</div>
</div><div class="mask ui-draggable" style="display: none;"><iframe frameborder="0" style="filter:progid:DXImageTransform.Microsoft.Alpha(opacity:0);position:absolute;top:0px;left:0px;width:100%;height:100%;" src="about:blank"></iframe></div></body></html>