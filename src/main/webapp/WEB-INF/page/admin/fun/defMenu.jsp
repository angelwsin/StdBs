...
<!DOCTYPE html>
<!-- saved from url=(0107)https://mp.weixin.qq.com/advanced/selfmenu?action=index&t=advanced/menu-setting&token=1423695882&lang=zh_CN -->
...
<link onerror="wx_loaderror(this)" rel="stylesheet" href="${root}/css/admin/advanced_menu_setting273ba2.css">
<link rel="stylesheet" type="text/css" href="${root}/css/admin/emotion_editor23b187.css">
<link rel="stylesheet" type="text/css" href="${root}/css/admin/tooltip218878.css">
    ...
    <div class="inner wrp">
        <h1 class="logo"><a href="https://mp.weixin.qq.com/" title="微信公众平台"></a></h1>
                        ...
                        <div class="account_meta account_info account_meta_primary">
                                ...
                                <a href="https://mp.weixin.qq.com/cgi-bin/settingpage?t=setting/index&action=index&token=1423695882&lang=zh_CN"><img src="./微信公众平台2_files/getheadimg" class="avatar"></a>
                            </div>
    ...
    <dt class="menu_title">
        ...
        https://res.wx.qq.com/mpres/htmledition/images/icon/menu/icon_menu_function.png
				...
				<dd class="menu_item "><a data-id="10005" href="${root }/adminWXFun/batchSend">群发功能        </a></dd>
					<dd class="menu_item "><a data-id="10006" href="${root}/adminWXFun/autoResp">自动回复        </a></dd>
					<dd class="menu_item selected"><a data-id="10007" href="${root}/adminWXFun/defMenu">自定义菜单        </a></dd>
				    ...
				    <dd class="menu_plugins"><a class="btn_plugins_add" data-id="10025" href="https://mp.weixin.qq.com/cgi-bin/plugincenter?t=service/plugins&act=all&token=1423695882&lang=zh_CN">添加功能插件<i class="icon_common new"></i></a></dd>
		</dl>
<dl class="menu ">
    <dt class="menu_title">
        <i class="icon_menu" style="background:url(
...
<div class="main_bd">
    <div class="highlight_box_wrp" id="menu_setting">
        ...
        <div class="reply_pop_tips popover normal_flow pos_right page_global_tips" id="div_alertTips" style="display:none">
            <div class="popover_inner">
                <div class="popover_content">
                    
                    <p class="">由于开发者通过接口修改了菜单配置，当前菜单配置已失效并停用。你可以前往<a href="https://mp.weixin.qq.com/advanced/advanced?action=dev&t=advanced/dev&token=1423695882&lang=zh_CN">开发者中心</a>进行停用。</p>
    ...
    <div class="plugin_update_tips page_msg mini" id="js_authrized" style="display:none">
        <div class="inner group">
            ...
            <div class="msg_content">
                <p>由于该公众号已授权给<span class="js_thirdname"></span>，请注意：本页的菜单设置已失效（且暂无法修改），若确认需要，可在<a href="https://mp.weixin.qq.com/cgi-bin/component_unauthorize?action=list&t=service/auth_plugins&token=1423695882&lang=zh_CN">授权管理</a>中取消授权。</p>
            </div>
        </div>
    </div>
	<div class="menu_setting_area_wrp" id="menu_container" style="display:none">
        <div class="menu_setting_area edit">
            ...
            <div class="inner_container_box side_l cell_layout">
                            ...
                            <div class="menu_manage">
                                <div class="sub_title_bar light">
                                    <h4>
                                        菜单管理                                    </h4>
                                    <div class="opr_wrp">
                                        <a href="javascript:void(0);" id="addBt" class="addBt opr_meta icon16_common add_gray">添加</a>
                                ...
                                <div class="inner_menu_box gray with_switch" id="menuList"></div>
                            </div>
                        </div>
                    </div>
                    <div class="inner_main">
                        <div class="bd">
                            ...
                            <div class="action_setting">
                                ...
                                <div class="action_content init default jsMain" id="none">
                                    <p class="action_tips"></p>
                                    <a href="javascript:void(0);" id="initialCreate" class="initialCreate"><i class="icon_menu_action add"></i><strong>添加二级菜单</strong></a>
                                </div>
                                ...
                                <div class="action_content sended jsMain" id="view">
                                    ...
                                    <div class="btn_wrp">
                                        <a href="javascript:void(0);" class="btn btn_default btn_editing" id="changeBt">修改</a>
                                    </div>
                                </div>														
                                ...
                                <div class="action_content send jsMain" id="edit">
                                    ...
                                    <p class="action_tips">订阅者点击该子菜单会收到以下消息，<a class="resetAction" href="javascript:void(0);">重设菜单内容</a></p>
                ...
                <p class="menu_msg mini_tips weak_text" style="display:none" id="menustatus_2">编辑中：点击下方“保存并发布”，才能更新到手机上 </p>
    ...
    <div class="menu_setting_empty_wrp dn">
        <img src="./微信公众平台2_files/menu_demo25404e.jpg">
        <p class="tips_global">你还未创建菜单</p>
        <a href="javascript:void(0);" class="addBt btn btn_primary">添加菜单</a>
    </div>
    </div>
<div class="mobile_preview" id="mobileDiv">
    <div class="mobile_preview_hd">
        <strong class="nickname">夕阳雨</strong>
    </div>
...
<script type="text/javascript">
    ...
    window.wx ={
        ...
        data:{
            ...
            nick_name:"夕阳雨",
            time:"1443187574"||new Date().getTime()/1000
        },
        path:{
...
define('page/homepage/plugins/plugin3.css', [], function(){return null;});
define('page/homepage/plugins/plugin2.css', [], function(){return null;});
define('page/homepage/plugins/plugin1.css', [], function(){return null;});
...
define('widget/tooltip.css', [], function(){return null;});</script>
<script onerror="wx_loaderror(this)" type="text/javascript" src="${root}/js/admin/layout.html23b289.js"></script>
<script onerror="wx_loaderror(this)" type="text/javascript" src="${root}/js/admin/editorRange218877.js"></script>
<script onerror="wx_loaderror(this)" type="text/javascript" src="${root}/js/admin/appmsg.html27402d.js"></script>
<script onerror="wx_loaderror(this)" type="text/javascript" src="${root}/js/admin/file_layout.html27d7ed.js"></script>
<script onerror="wx_loaderror(this)" type="text/javascript" src="${root}/js/admin/plugin223b289.js"></script>
<script onerror="wx_loaderror(this)" type="text/javascript" src="${root}/js/admin/video238f6d.js"></script>
<script onerror="wx_loaderror(this)" type="text/javascript" src="${root}/js/admin/tooltip.html218877.js"></script>
<script onerror="wx_loaderror(this)" type="text/javascript" src="${root}/js/admin/menuSetting2880f5.js"></script>
<script type="html/text" id="tpl">
    ...
    <dl class="inner_menu jsMenu">
        ...
        <span class="menu_opr">
            <a href="javascript:void(0);" class="js_addSecondMenu icon14_common add_gray jsAddBt">添加</a>
        ...
        <i class="icon_dot">●</i>
        <a href="javascript:void(0);" class="inner_menu_link" onclick="return false;">
...
<script type="html/text" id="viewTpl">
    ...
    <a href="javascript:void(0);" class="jsView pre_menu_link" title="{menu.name}">
    {if menu.subs}
    ...
    <div class="sub_pre_menu_box jsSubViewDiv" style="display:none">
        <ul class="sub_pre_menu_list">
            {each menu.subs as sub}
            <li id="{sub.id}"><a href="javascript:void(0);" class="jsSubView" title="{sub.name}">{sub.name}</a></li>
            {/each}
        </ul>
        ...
        <div class="inner">
            ...
            <div class="msg_content">
                ...
                <ul>
                   ...
                   <li>1. 阅读自定义菜单<a href="http://mp.weixin.qq.com/wiki/index.php?title=%E8%87%AA%E5%AE%9A%E4%B9%89%E8%8F%9C%E5%8D%95%E5%88%9B%E5%BB%BA%E6%8E%A5%E5%8F%A3" target="_blank">接口文档</a>，并在<a href="/advanced/advanced?action=dev&t=advanced/dev&token=1423695882" target="_blank">开发者中心</a>获取AppID和AppSecret</li>
					<li>2. 通过自定义菜单接口，创建、修改和删除自定义菜单</li>
					<li>3. 阅读接入指南<a href="http://mp.weixin.qq.com/wiki" target="_blank">接口文档</a>，并在<a href="/advanced/advanced?action=dev&t=advanced/dev&token=1423695882" target="_blank">开发者中心</a>设置回调URL和Token,以接收自定义菜单的开发者事件推送</li>
...
<div class="faqscene_inner">
    ...
    <div class="faqscene_panel js_faq_main_panel" style="display: none;">
        <a href="https://mp.weixin.qq.com/advanced/selfmenu?action=index&t=advanced/menu-setting&token=1423695882&lang=zh_CN###" class="faqscene_close">x</a>
        <div class="faqscene_hd">自定义菜单问题</div>
        <div class="faqscene_bd">
            <div class="faqscene_tabs">
                <div class="faqscene_tab_hd">
                    <ul class="js_faq_class1">
                ...
                <div class="faqscene_tab_bd js_faqscene_content" style="display: block;">
                    <ul>
                        ...
                        <li><a target="_blank" href="http://kf.qq.com/faq/120911VrYVrA150210BBJvei.html?scene_id=pc100">自定义菜单介绍</a></li>
                        
                        
                        
                        <li><a target="_blank" href="http://kf.qq.com/faq/120911VrYVrA150917IvMzMj.html">自定义菜单发布后手机端不显示</a></li>
                        
                        
                        
                        <li><a target="_blank" href="http://kf.qq.com/faq/120911VrYVrA150303UrYzMR.html?scene_id=pc101">自定义菜单纯文字消息编辑方法</a></li>
                        
                        
                        
                        <li><a target="_blank" href="http://kf.qq.com/faq/120911VrYVrA150303rYbq63.html?scene_id=pc102">自定义菜单纯图文消息编辑方法介绍</a></li>
                        
                        
                        
                        <li><a target="_blank" href="http://kf.qq.com/faq/120911VrYVrA150212ENnyqM.html?scene_id=pc103">自定义菜单跳转到网页编辑方法介绍</a></li>
        ...
        <div class="faqscene_ft"><a href="http://kf.qq.com/faq/120911VrYVrA150210BBJvei.html?scene_id=pc267" target="_blank">点击查看更多</a></div>
    </div>
</div>
</div></body></html>